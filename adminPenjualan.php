  ...
  <div class="flex h-full">
    ...
    <div class="md:w-56 w-full md:block hidden flex-col justify-between border-e bg-white flex-grow-0">
      <div>
        ...
        <ul class="mt-6 space-y-1">
          <li>
            <a href="adminPenjualan.php" class="bg-[#D23D2D] block rounded-lg px-4 py-2 text-sm font-medium text-white hover:bg-[#31603D] hover:text-gray-700">Cek Penjualan</a>
          </li>
          <li>
    ...
    <div class="flex-1 p-6 overflow-auto">
      ...
      <div class="mx-auto max-w-lg text-center">
        <h2 class="text-3xl text-[#D23D2D] mt-10 -mb-5 font-bold sm:text-4xl">Check Penjualan</h2>
        <a href="admin.php">
